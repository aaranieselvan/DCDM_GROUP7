...
for (file in file_list) {
  ...
  missing_fields <- setdiff(correct_fields, names(reshaped_data))  #We found no missing fields, so NAs were added
...
write.csv(final_combined_data, "~/Desktop/DCDM_Group7/outputs/final_combined_output.csv", row.names = FALSE)
