...
processed_data <- t(sapply(lines, process_line))
...
```{r}
processed_data_correct_row_names = as_tibble(processed_data, rownames = "disease_id")
View(processed_data_correct_row_names)

#remove first column
processed_data_correct_row_names2 = processed_data_correct_row_names[, -1]
View(processed_data_correct_row_names2)

# Check the number of columns in the dataframe
num_columns <- ncol(processed_data_correct_row_names2)
...
colnames(processed_data_correct_row_names2) = processed_data[1, ]   # Set the first row as the column names
new_processed_data = processed_data_correct_row_names2[-1, ]            # Remove the first row which is now the header
...
#Convert to csv
```{r}
write.csv(new_processed_data, "Disease_info.csv", row.names = FALSE)
```
