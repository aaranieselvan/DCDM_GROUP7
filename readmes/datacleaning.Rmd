...
write.csv(normalised_gene_symbol, "~/Desktop/DCDM_Group7/outputs/normalised.csv", row.names = FALSE)
```
...
# Save the output file 
write.csv(removed_p_values, "~/Desktop/DCDM_Group7/outputs/removed_p_values.csv", row.names = FALSE)
...
write.csv(clean_final_data, "~/Desktop/DCDM_Group7/outputs/clean_final_data.csv", row.names = FALSE)
```
...
write.csv(clean_disease_info, "~/Desktop/DCDM_Group7/outputs/Disease_information_clean.csv", row.names = FALSE)
```
...
# Read the file line by line
lines2 <- readLines("~/Desktop/DCDM_GROUP7/outputs/IMPC_parameter_description_clean.txt")
...
# Save the output file 
write.csv(clean_parameter_description, "~/Desktop/DCDM_Group7/outputs/IMPC_parameter_description_clean.csv", row.names = FALSE)
```
...
# Read the file line by line
lines3 <- readLines("~/Desktop/DCDM_GROUP7/outputs/IMPC_procedure_clean.txt")
...
# Save the output file 
write.csv(clean_Pro, "~/Desktop/DCDM_Group7/outputs/IMPC_procedure_clean.csv", row.names = FALSE)
```
